...
import com.dani.naversearch.databinding.FragmentCafeSearchBinding
...
class CafeSearchFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        recyclerView = binding.rvCafeList
    ...
    private fun initNavigationBar(searchKeyword: String) {
        ...
        api.getSearch("cafearticle", searchKeyword).enqueue(object : Callback<ResultGetSearch> {
